...
$result = $reportDef->getReportCustomFields( NULL, $range, $sort, "CUSTOM_DATE", 'XML', 
	array(
		'CampaignId', 'CampaignName', 'AverageCpc', 'ConversionRate', 'Conversions'
	) 
);
